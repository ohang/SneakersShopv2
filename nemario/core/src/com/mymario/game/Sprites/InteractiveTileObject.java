...
public abstract class InteractiveTileObject {
    ...
    public InteractiveTileObject(PlayScreen screen, Rectangle bounds){
        ...
        bdef.position.set((bounds.getX() +bounds.getWidth()/2)/ MyMario.PPM,(bounds.getY() + bounds.getHeight()/2)/MyMario.PPM);

        body = world.createBody(bdef); // avelacnum enw  worldum


        shape.setAsBox(bounds.getWidth()/2/MyMario.PPM, bounds.getHeight() /2/MyMario.PPM);
        fdef.shape = shape;
